...
function assertValidPost(post: BlogPost) {
  ...
  // R14-F3: the live's meta description (distinct from the card excerpt)
  expect(post.metaDescription.length).toBeGreaterThanOrEqual(40)
  expect(post.metaDescription.length).toBeLessThanOrEqual(320)
